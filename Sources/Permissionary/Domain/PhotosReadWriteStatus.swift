//
//  PhotosReadWriteStatus.swift
//  Permissionary
//
//  Created by Tim Isaev
//

/// The photo library read/write capability's typed status.
///
/// ``PermissionAuthorization/limited`` means the user granted access to a
/// selection of photos rather than the whole library; it is a successful
/// state, and ``PermissionRecovery/manageLimitedSelection`` lets the user
/// change the selection.
public struct PhotosReadWriteStatus: PermissionStatus, Equatable {
